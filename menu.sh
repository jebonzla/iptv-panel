...
if [[ "$1" == "-c" || "$1" == "--checker" ]]; then
    ...
    while true; do
        req_head="${BLUE} â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”${END} ${GREEN}BY JOMZTV${END} ${BLUE}â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”${END}"
        clear
        ...
        echo -e "${BLUE}â•‘\E[0m            â€¢ JOMZ OTT SYSTEM â€¢           ${BLUE}â•‘\E[0m"
        echo -e "${BLUE}â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•${END}"
        echo -e "${BLUE}â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—${END}"
        echo -e "${BLUE}â• ${END} ${CYAN}DOMAIN${END}     : ${GREEN}${domain}${END}${BLUE}               â•‘\E[0m"
        echo -e "${BLUE}â• ${END} ${CYAN}IP SERVER${END}  : ${GREEN}${ipvps}${END}${BLUE}               â•‘\E[0m"
        echo -e "${BLUE}â• ${END} ${CYAN}TOTAL USER${END} : ${GREEN}${total_user} Users${END}${BLUE}                     â•‘\E[0m"
        echo -e "${BLUE}â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•${END}"
        echo -e "${BLUE}â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[ 1]${END}. ${CYAN}Register Reseller${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[ 2]${END}. ${CYAN}Add User${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[ 3]${END}. ${CYAN}Delete User${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[ 4]${END}. ${CYAN}Get User Data${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[ 5]${END}. ${CYAN}Get User Data (By short link)${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[ 6]${END}. ${CYAN}Get Users by Reseller${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[ 7]${END}. ${CYAN}Check User Multilogin${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[ 8]${END}. ${CYAN}Check All Multilogin${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[ 9]${END}. ${CYAN}Renew User${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[10]${END}. ${CYAN}Add Balance${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[11]${END}. ${CYAN}Add User Custom${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[12]${END}. ${CYAN}Renew User Custom${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[13]${END}. ${CYAN}Get All Resellers${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[14]${END}. ${CYAN}Get All Agents${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[15]${END}. ${CYAN}Add Secure URL${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[16]${END}. ${CYAN}Edit Secure URL${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[17]${END}. ${CYAN}Add Secure VOD${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[18]${END}. ${CYAN}Check Shortlink${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[19]${END}. ${CYAN}Unban Multilogin${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[20]${END}. ${CYAN}Unban Sniffer${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[21]${END}. ${CYAN}Restart Services${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[22]${END}. ${CYAN}Manual Backup${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[23]${END}. ${CYAN}Change Secure Stat${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[24]${END}. ${CYAN}Change UUID Stat${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[25]${END}. ${CYAN}Change IP Stat${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[26]${END}. ${CYAN}Clear All Expired${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[27]${END}. ${CYAN}Ban sniffer${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[28]${END}. ${CYAN}Check Suspicious Log${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[29]${END}. ${CYAN}Check All Secure Short Status${END}"
        echo -e "${BLUE}â• ${END} ${GREEN}[30]${END}. ${CYAN}Update Bearer [Sooka]${END}"
        echo -e "${BLUE}â•š${END} ${GREEN}[31]${END}. ${RED}Exit${END}"
        echo -e "${BLUE}â•š${END} ${GREEN}[U]${END} . ${BLUE}UPDATE${END}"
        echo -e "${BLUE}â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•${END}"
        echo -e "${BLUE} â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”${END} ${GREEN}BY JOMZTV${END} ${BLUE}â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”${END}"
        echo -e ""
